...
function activateTypeSelector(field_class, section_class) {
  ...
  $("div." + field_class + " > div." + section_class)
    .not(".chosen")
    .find("input")
  ...
  $("div." + field_class)
    ...
    .on("click", function () {
      ...
      wrapper
        .find("div.chosen." + section_class)
        .removeClass("chosen")
        .find("input")
        .attr("disabled", "disabled");
      wrapper
        .find("div." + section_class + "." + chosen)
        .addClass("chosen")
        .find("input")
        .removeAttr("disabled");

      wrapper.find(".icon").each(function () {
        $(this).attr("src", $(this).data("iconInactive"));
      });
      input.siblings(".icon").each(function () {
        $(this).attr("src", $(this).data("iconCreate"));
      });
    });
}
